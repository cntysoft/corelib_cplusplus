...
{
public:
   const static QString PARAMETERIZATION_POSITIONAL;
   const static QString PARAMETERIZATION_NAMED;
   const static QString NAME_FORMAT_CAMELCASE;
   const static QString NAME_FORMAT_NATURAL;
public:
   virtual QString getDatabasePlatformName(const QString &nameFormat = NAME_FORMAT_CAMELCASE) = 0;
