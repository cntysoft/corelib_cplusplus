...
#include "mysql/alter_table_decorator.h"
...
Mysql::Mysql()
{
   ...
   setTypeDecorator("sn::corelib::db::sql::platform::mysql::AlterTableDecorator", 
                    QSharedPointer<AbstractSql>(new mysql::AlterTableDecorator));
}
